...
class Loss_Functions:
    def __init__(self, args):
        ...
        self.alpha['style']['source2target'] = 5e4
        self.alpha['style']['target2source'] = 1e4
        self.alpha['dis']['source'] = 0.5
        self.alpha['dis']['target'] = 0.5
        self.alpha['gen']['source'] = 0.5
        self.alpha['gen']['target'] = 1.0
